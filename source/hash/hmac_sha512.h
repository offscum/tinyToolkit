#ifndef __HASH__HMAC_SHA512__H__
#define __HASH__HMAC_SHA512__H__
...
namespace tinyToolkit
{
	namespace hash
	{
		class TOOLKIT_API HMAC_SHA512
		{
			static const uint32_t PAD_SIZE = 128;
			static const uint32_t DIGEST_SIZE = 64;
...
#endif // __HASH__HMAC_SHA512__H__
